...
impl Intcode {
    ...
    fn step(&mut self) {
        ...
        match inst {
            ...
            _ => panic!("instruction {inst} unimplemented"),
        }
    }
...
mod tests {
    ...
    #[test]
    fn test_halt() {
        let mut computer = Intcode::new_from_string("99");
        computer.run();
    ...
    #[test]
    fn test_add() {
        let mut computer = Intcode::new_from_string("1,0,2,0,99");
        computer.run();
    ...
    fn test_multiplication() {
        let mut computer = Intcode::new_from_string("2,4,2,0,99");
        computer.run();
    ...
    #[test]
    fn test_peek() {
        let computer = Intcode::new_from_string("2,4,2,0,99");
    ...
    fn test_day_2_part_1() {
        ...
        for entry in matrix {
            let mut computer = Intcode::new_from_string(entry.0);
            computer.run();
